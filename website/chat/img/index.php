...
<div class="col-lg-1 col-md-2 col-sm-4 col-xs-1 ml-auto ">
  ...
  <button  type="button" class="btn btn-danger logout_btn" data-toggle="modal" data-target="#exampleModalCenter">
     Logout
    </button>
        ...
        <div class="container">
                ...
                <main>
                            ...
                            <div class="userSettings">
                                    ...
                                    <input class="form-control" id="userName" type="text" placeholder="Username" maxlength="32" value="Somebody">
                                </div>
...
<div class="list-group ">
  ...
  <a href="#" class="list-group-item list-group-item-action">Patients' Images</a>
  <a href="./chat" class="list-group-item list-group-item-action">Chat Now</a>
  <a href="#" class="list-group-item list-group-item-action">Add new patient</a>
  <a href="#" class="list-group-item list-group-item-action disabled">Add registered patient</a>
</div>
</div>
</div>
