...
$username_err = $tempreture_err = $heartrate_err = $illness_err = $medicines_err = $phone_err = $Birth_Date_err = "";
	...
	$sqli = "SELECT * FROM patients where Doctor IS NULL or Doctor= '' ";
...
<head>
    <meta charset="UTF-8">
    <title>Add registered Patient</title>
...
<section class="home" id="crud">
 ...
 <div class="container" id="crud">
           <div class="page-header">
                    ...
                    <p>Please choose patient to be added to yours.</p>
                    <form action="select.php" method="POST">
                        <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                            <label>Patient Name</label>
							<select name="patient" class="form-control" > <?php echo $options;?></select>
...
<div class="list-group ml-auto">
  ...
  <a href="addexisting.php" class="list-group-item list-group-item-action active">Add registered patient</a>
</div>
</section>
